...
public class CustomFireball extends Fireball implements ProjectileWithPower {
  ...
  protected void onHitEntity(EntityHitResult hit) {
    ...
    if (!this.level().isClientSide) {
      ...
      if (target.hurt(source, getDamage()) && owner instanceof LivingEntity livingOwner) {
        if (target instanceof LivingEntity targetLiving && this.level() instanceof ServerLevel serverLevel) {

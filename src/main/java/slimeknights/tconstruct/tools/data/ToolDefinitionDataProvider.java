...
public class ToolDefinitionDataProvider extends AbstractToolDefinitionDataProvider {
  ...
  protected void addToolDefinitions() {
    ...
    defineArmor(ArmorDefinitions.SLIMESUIT)
      ...
      .module(ArmorItem.Type.LEGGINGS, MaterialStatsModule.stats().stat(new MaterialStatsId(RepairStats.SHELL.getId())).stat(SlimeStats.ID, 1.5f).build())
      ...
      .module(ArmorItem.Type.BOOTS, MaterialStatsModule.stats().stat(new MaterialStatsId(RepairStats.LACES.getId())).stat(SlimeStats.ID, 1.3f).build())
